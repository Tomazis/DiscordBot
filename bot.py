...
| @@ fjoin                   | Play file.                             |
| @@ [link to youtube video] | Play youtube video from link.          |
| @@ playlist                | Show the playback queue.               |
| @@ clear                   | Clear playlist.                        |
| @@ skip                    | Skip the current track.                |
| @@ volume [from 0 to 100]  | Set volume.                            |
| @@ purge [number]          | Delete last [number] of lines in chat. |
| @@ speak                   | Play from server line-in.              |
| @@ speak_tcp               | Play from GUI.                         |
-----------------------------------------------------------------------
```'''
        await bot_.client.send_message(channel,
                                       help)
